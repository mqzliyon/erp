...
public class ManagerUttaraFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_manager_uttara, container, false);
    ...
    private void saveStockSummary(String productType, int openingStock, int receiptFactory, 
        ...
        StockSummary stockSummary = new StockSummary(
            ...
            todaySale, closingStock, date, userId, "Uttara"
        );
