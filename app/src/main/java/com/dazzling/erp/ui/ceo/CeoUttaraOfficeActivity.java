...
public class CeoUttaraOfficeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceo_uttara_office);
        ...
        firestoreService.verifyFirebaseConnection(
            () -> Log.d("CeoUttaraOffice", "✅ Firebase connectivity verified"),
            () -> Log.e("CeoUttaraOffice", "❌ Firebase connectivity failed")
        );
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Uttara Office");
        }
    ...
    protected void onPause() {
        ...
        try {
            ...
            Log.e("CeoUttaraOffice", "Error in onPause", e);
        }
    }
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            Log.e("CeoUttaraOffice", "Error in onDestroy", e);
        }
    }
    ...
    private void loadStockSummariesFromFirebase() {
        ...
        // Load stock summaries for Uttara office
        firestoreService.getStockSummariesByOffice("Uttara", new FirestoreService.StockSummaryCallback() {
            @Override
            public void onStockSummariesLoaded(List<StockSummary> summaries) {
                runOnUiThread(() -> {
                    ...
                    // Log loaded data
                    Log.d("CeoUttaraOffice", "Loaded " + summaries.size() + " stock summaries from Firebase");
